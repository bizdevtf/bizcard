...
### 방법 A — 아이폰 공유 시트 (권장, 한 번 탭)

카메라로 명함을 찍고 **공유하기 → "명함 저장" 단축어**를 탭하면
Claude API가 명함을 인식해 바로 연락처 저장 화면이 뜬다.
설정 방법: [docs/ios-shortcut.md](docs/ios-shortcut.md) (Anthropic API 키 필요)
